...
<c:if test="${sessionScope.userId!=null && sessionScope.role == 101}">
    <%-- Admin is logged in : Admin Menu --%>    
    <a href="#">Home</a> | <a href="<s:url value="/admin/users"/>">User List</a> | <a href="${url_logout}">Logout</a>  
</c:if>
<c:if test="${sessionScope.userId!=null && sessionScope.role == 102}">
    <%-- Librarian is logged in : Librarian Menu --%>    
    <a href="#">Home</a> | <a href="<s:url value="/Librarian/users"/>">User List</a> | <a href="${url_logout}">Logout</a>  
</c:if>
